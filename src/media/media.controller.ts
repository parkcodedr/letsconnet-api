// src/posts/controllers/media.controller.ts
import {
  Controller,
  Get,
  Post,
...
import { CreateMediaCommentDto, MediaReactionDto, UpdateMediaCommentDto } from './dto/media-comment.dto';
...
export class MediaController {
  ...
  async getMediaReactionUsers(
    ...
    return this.mediaService.getMediaReactionUsers(mediaId, userId, type, page, limit);
  }
  ...
  async getMediaComments(
    ...
    return this.mediaService.getMediaComments(mediaId, userId, page, Math.min(limit, 50), sortBy);
  }
